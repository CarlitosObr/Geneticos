...
public class archivos {
    ...
    public static void escribir(ArrayList<Reina> poblacion) {
        File carpetanueva = new File("Poblaciones");
        carpetanueva.mkdirs();
    ...
    public static ArrayList<Reina> tokenizarDataSet() throws IOException {
